...
class Mesh3 : public Shape {
    public:
        Mesh3(vector<Triangle*> faces_, BoundingBoxR bbox_, Material3 material_, Vector3R anchor_, string name_);
        ~Mesh3();

        static Mesh3* create_from_obj_file(string filename, Material3 material_, string name_);
